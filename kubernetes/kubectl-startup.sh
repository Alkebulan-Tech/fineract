...
kubectl create secret generic fineract-tenants-db-secret --from-literal=username=mifos --from-literal=password=$(head /dev/urandom | LC_CTYPE=C tr -dc A-Za-z0-9 | head -c 16)
